...
export default function Create({ auth }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(route('pengalamans.store')); // Mengirim data ke server
    };

    return (
        <AuthenticatedLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Tambah Pengalaman</h2>}
        >
            <Head title="Tambah Pengalaman" />
